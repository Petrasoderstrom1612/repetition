...
return (
  <>
  <ListGroup.Item key={post.id} className={`${post.done ? "completed" : ""} mb-3`} onClick={() => changeDone(post.id, post.done)}><span className="todo-title">{post.title} {post.likes} likes</span>
  <div>
